...
| PL/SQL Programming | [`JAVA FS Engineer/PROGRAMING LANGUAGES/PL:SQL programming`](<JAVA FS Engineer/PROGRAMING LANGUAGES/PL:SQL programming/README.md>) | Control structures, stored procedures, banking schema |
| Logging with SLF4J | [`JAVA FS Engineer/PROGRAMING LANGUAGES/SLF4J logging framework`](<JAVA FS Engineer/PROGRAMING LANGUAGES/SLF4J logging framework/README.md>) | SLF4J + Logback logging levels demo |
| TDD with JUnit & Mockito | [`JAVA FS Engineer/PROGRAMING LANGUAGES/TDD using JUnit5 and Mockito`](<JAVA FS Engineer/PROGRAMING LANGUAGES/TDD using JUnit5 and Mockito/README.md>) | Unit testing, assertions, fixtures, mocking, and verification |
...
PL/SQL scripts are run inside an Oracle SQL client (SQL*Plus, SQL Developer, etc.) — see the [PL/SQL programming README](<JAVA FS Engineer/PROGRAMING LANGUAGES/PL:SQL programming/README.md>) for details.
